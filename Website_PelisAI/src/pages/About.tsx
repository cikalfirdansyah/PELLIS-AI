  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-20">
        <div className="max-w-screen px-4 mx-auto lg:py-24 lg:px-6 max-[640px]">
          <div className=" mx-auto text-center mb-8 lg:mb-12">
            ...
            <p className="mb-5 font-base text-gray-500 sm:text-lg">
              Pelis AI, is dedicated to advancing early detection of skin conditions and making skin checks an accessible part of your health routine. Our mission is simple yet
              impactful: to inspire, educate, and empower individuals and healthcare professionals in recognizing and addressing skin concerns, for better skin health within our
              communities.
            </p>
          </div>
        </div>
        ...
        <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 sm:justify-items-center justify-items-center gap-8 mt-12">
          {teamMembers.map((member) => (
            <div key={member.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
              {" "}
              <div className="flex flex-col items-center py-10">
                <img src={member.imageUrl} className="w-24 h-24 mb-3 rounded-full shadow-lg object-cover" alt={member.name} />
